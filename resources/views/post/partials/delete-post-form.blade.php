<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Once your post is deleted, all of its resources and data will be permanently deleted. Before deleting your post, please download any data or information that you wish to retain.') }}
        </p>
    </header>
